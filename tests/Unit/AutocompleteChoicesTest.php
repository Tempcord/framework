...
final class AutocompleteChoicesTest extends TestCase
{
    /** @return list<ApplicationCommandOptionChoice> */
    private function toChoices(mixed $value): array
    {
        return new ReflectionMethod(CommandsRegistry::class, 'toChoices')
            ->invoke(new CommandsRegistry(new AllCommandExtension()), $value);
    }
